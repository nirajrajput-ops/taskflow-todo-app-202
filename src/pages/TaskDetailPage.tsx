...
export const TaskDetailPage: React.FC = () => {
  ...
  const handleToggleSubtask = (subtaskId: string) => {
    ...
    const isCompletingSubtask = subtask && !subtask.completed;
    toggleSubtask(task.id, subtaskId);
    if (isCompletingSubtask && typeof pendo !== 'undefined') {
      ...
      pendo.track('subtask_completed', {
        ...
        isTaskNowFullyComplete: newCompletedCount === task.subtasks.length,
      });
    }
  };
